...
export default function AIStar({ size = 2, color }: AIStarProps) {
  const emSize = `${size}em`;
  const fillValue = color ? color : 'url(#icon-gradient)';
